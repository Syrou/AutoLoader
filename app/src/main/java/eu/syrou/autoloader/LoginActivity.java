...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView mDeviceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceView = (AutoCompleteTextView) findViewById(R.id.email);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mDeviceView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        String email = mDeviceView.getText().toString();
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mDeviceView.setError(getString(R.string.error_invalid_email));
            focusView = mDeviceView;
            cancel = true;
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        mDeviceView.setAdapter(adapter);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private Device lastIteratedDevice;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                lastIteratedDevice.launchDeviceView(LoginActivity.this);
            }
        }
